...
<body>
    ...
    <div class="text-center pt-5">
        <a href="https://github.com/vitorhugo8" target="__blank" class="nav-link"><code><i class="fab fa-github-alt"></i><strong> Digite as informações abaixo:</strong></code></a>
    </div>
        ...
        <div>
            <div class="card mb-3 shadow login" id="cardLogin" style="max-width: 540px;">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">sinet - Login</h5>
                            <div class="row">
